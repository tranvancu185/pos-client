...
import IconChair from 'src/components/icon/IconChair';
...
const DashboardPage = () => {
  ...
  const getFeatureIcon = (feature) => {
    switch (feature) {
      case 'window':
        return <IconUser className="text-blue-500" />;
      case 'power outlet':
        return <FaWifi className="text-green-500" />;
      case 'smoking allowed':
        return <FaSmokingBan className="text-red-500" />;
      default:
        return null;
    }
  };
            ...
            <motion.div
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <motion.button
                  ...
                  <FaMobileAlt className="mr-2" /> Mobile Payment
                </motion.button>
              </div>
            </motion.div>
          )}
